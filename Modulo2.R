...
#Para la variables de usuarios de internet y poblacion se usa gsub para poder cambiar la coma por punto como separador de miles

#Se realiza transformaciones con los NA dentro de algunas variables de la base, estos NA se cambian por el valor 0, ya que son variables númericas. 
base_nueva <- data %>%
